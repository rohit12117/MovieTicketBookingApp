...
class Movie2 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val btnDate = findViewById<Button>(R.id.btnDate2)
        ...
        val btnTime = findViewById<Button>(R.id.btnTime2)
        var alarmManager: AlarmManager
        val intent = Intent(this, AlarmBroad::class.java)
        val pendingIntent = PendingIntent.getBroadcast(this, 234, intent,
            PendingIntent.FLAG_IMMUTABLE)

        var tv = findViewById<TextView>(R.id.tv2)
        var etText = findViewById<EditText>(R.id.etText2)
//      Putting the time picker
        ...
        val btntrail = findViewById<Button>(R.id.btnTrail2)

        btntrail.setOnClickListener {
            Intent(this, Trailer2::class.java).apply{
                startActivity(this)
            }
        }
